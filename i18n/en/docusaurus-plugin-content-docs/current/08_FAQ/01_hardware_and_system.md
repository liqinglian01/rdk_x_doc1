...
1.  **Compiling regular Linux C/C++ applications:**
    * **Obtain the cross-compilation toolchain:** D-Robotics provides a toolchain for each RDK series (e.g., X3, X5, and others), usually as part of the SDK or as a separate download. The toolchain includes `aarch64-linux-gnu-gcc`, `aarch64-linux-gnu-g++`, etc.
